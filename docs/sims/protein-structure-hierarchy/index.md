...
description: Interactive four-panel display showing the four levels of protein structure with toggle buttons to view one level at a time, including descriptions and visual representations.
image: /sims/protein-structure-hierarchy/protein-structure-hierarchy.png
og:image: /sims/protein-structure-hierarchy/protein-structure-hierarchy.png
twitter:image: /sims/protein-structure-hierarchy/protein-structure-hierarchy.png
social:
   cards: false
quality_score: 3
---
...
4. [Protein quaternary structure — Wikipedia](https://en.wikipedia.org/wiki/Protein_quaternary_structure)
