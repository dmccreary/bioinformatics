...
|---|---------|-------|--------|-------|
| 1 | Concepts | 480 | Required | Concepts from learning graph |
| 2 | Chapters | 16 | Required | Chapter directories with index.md |
| 3 | MicroSims | 55 | Recommended | Interactive simulations in docs/sims/ |
| 4 | Stories | 0 | Optional | Graphic-novel narratives in docs/stories/ |
| 5 | Chapter Quizzes | 16 / 16 | Recommended | Chapters with a quiz.md (160 questions total) |
| 6 | Chapter References | 16 / 16 | Recommended | Chapters with references.md (160 references total) |
| 7 | Glossary Terms | 480 | Recommended | Defined terms in glossary.md |
| 8 | FAQs | 91 | Recommended | Questions in faq.md |
| 9 | Words | 203,614 | Required | Words across student-facing markdown |
...
|-------------|-------------|---------------|-------|
| Diagrams | 52 | 52 | H4 headers starting with '#### Diagram:' |
| Equations | 724 | 673 | LaTeX expressions (inline and display) |
| Total Words | 203,614 | 106,410 | Words in markdown files |
| Links | 764 | 228 | Hyperlinks in markdown format |
| Equivalent Pages | 854 | 466 | Estimated pages (250 words/page + visuals) |
