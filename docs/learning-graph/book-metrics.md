...
| Concepts | 480 | [Concept List](./concept-list.md) | Concepts from learning graph |
...
|-------------|-------------|---------------|-------|
| Diagrams | 42 | 42 | H4 headers starting with '#### Diagram:' |
| Equations | 463 | 463 | LaTeX expressions (inline and display) |
| Total Words | 71,896 | 62,831 | Words in markdown files |
| Links | 102 | 75 | Hyperlinks in markdown format |
| Equivalent Pages | 299 | 262 | Estimated pages (250 words/page + visuals) |
