# Learning Graph for Bioinformatics
...
- Validates course description has sufficient depth for generating 480 concepts
...
- Connectivity: all 480 nodes connected in a single component
...
- Balanced categories (3.1% - 11.0% each)
