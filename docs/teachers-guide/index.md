...
5. **Welcome from Olli** — A mascot admonition that introduces the chapter topic in Olli the Octopus's friendly voice.
6. **Main content** — The core instructional material, written at an undergraduate reading level. Includes tables, real-world examples, and embedded MicroSims.
7. **Mascot admonitions** — Throughout the chapter, Olli appears 5-6 times to highlight key insights (thinking), offer practical tips (tip), provide encouragement on harder concepts (encourage), and warn about common mistakes (warning).
8. **Key takeaways** — A numbered summary of the most important concepts, preceded by a celebration from Olli.
...
!!! mascot-tip "Olli's Tip: Embed MicroSims Anywhere!"
    <img src="../img/mascot/tip.png" class="mascot-admonition-img" alt="Olli shares a tip">
    ...
    ```html
    <iframe src="https://dmccreary.github.io/bioinformatics/sims/YOUR-MICROSIM-NAME/main.html"
...
1. Go to the textbook's GitHub repository: [dmccreary/bioinformatics](https://github.com/dmccreary/bioinformatics)
...
1. Go to [dmccreary/bioinformatics](https://github.com/dmccreary/bioinformatics)
...
theme:
  palette:
    primary: teal      # Change to: blue, red, purple, green, etc.
...
4. Open your browser to `http://127.0.0.1:8000/bioinformatics/` to see your customized version
